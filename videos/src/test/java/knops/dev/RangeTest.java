...
public class RangeTest {
    ...
    public void testGetRangeEnd() {
        Range range = Range.builder().start(10).end(20).build();
        assertEquals(19, range.getRangeEnd(20)); // Assuming fileSize is 20
    }
    ...
    public void testParseHttpRangeStringWithNullInput() {
        ...
        assertEquals(49, range.getRangeEnd(50)); // Assuming defaultChunkSize is 50
    }
    ...
    public void testParseHttpRangeStringWithValidInput() {
        ...
        assertEquals(15, range.getRangeEnd(50)); // Assuming defaultChunkSize is 50
    }
